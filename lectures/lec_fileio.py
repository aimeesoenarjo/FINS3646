...
# Check if the file is closed (line of communication between fobj and file)
print(fobj.closed) # This is false if the file is open

# Close the file (cannot communicate with it using fobj)
fobj.close()
print(fobj.closed) # This will become true
